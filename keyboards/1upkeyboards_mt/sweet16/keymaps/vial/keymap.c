...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[FN1]=LAYOUT_ortho_4x4(
        ...
        KC_LGUI, ____,    ____,    ____,    ____,    ____,    ____,    ____,    KC_MINS, KC_EQL,  KC_QUOT, KC_BSLS, 
        KC_LCTL, ____,    ____,    ____,    ____,    ____,    ____,    ____,    KC_DOT,  ____,    KC_RSFT,          KC_VOLU,
        KC_LALT, ____,    KC_SPC,  KC_MUTE,                                                                KC_MPRV, KC_VOLD, KC_MNXT 
    ),
	
	[FN2]=LAYOUT_ortho_4x4(
        KC_PWR,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
        KC_TAB,  KC_INS,  KC_HOME, KC_PGUP, KC_PSCR, ____,    ____,    ____,   	____, 	 ____,    ____,    ____,
        KC_LCTL, KC_DEL,  KC_END,  KC_PGDN, ____,    ____,    ____,    ____,   	____, 	 ____,    KC_RSFT,          RGB_SAI, 
        KC_LALT, KC_CAPS, KC_MPLY, ____,                                                                   RGB_TOG, RGB_HUI, RGB_MOD
    ),
